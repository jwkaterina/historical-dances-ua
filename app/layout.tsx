  ...
  return (
    <html lang="en">
      <body className={`font-sans antialiased`}>
        ...
        <Analytics />
        {/* v0 – built-with badge */}
        <div dangerouslySetInnerHTML={{ __html: `<div id="v0-built-with-button-fdef6dde-3126-40a8-b246-57a90a73d6ce" style="
...
">
<a
  href="https://v0.app/chat/api/open/built-with-v0/b_QYiavLfQAp1?ref=2FIS7D"
  target="_blank"
  rel="noopener"
  style="
    color: inherit;
...
<button
  onclick="document.getElementById('v0-built-with-button-fdef6dde-3126-40a8-b246-57a90a73d6ce').style.display='none'"
